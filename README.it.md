...
nix run github:ravipacharpro-jpg/nexus-Official           # oppure github:ravipacharpro-jpg/nexus-Official per l’ultima branch di sviluppo
```
...
NEXUS è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/ravipacharpro-jpg/nexus-Official/releases) oppure da [nexus.ai/download](https://nexus.ai/download).
