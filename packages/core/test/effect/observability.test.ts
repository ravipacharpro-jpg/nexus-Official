...
describe("resource", () => {
  test("parses and decodes OTEL resource attributes", () => {
    process.env.OTEL_RESOURCE_ATTRIBUTES =
      "service.namespace=nexus,team=platform%2Cobservability,label=hello%3Dworld,key%2Fname=value%20here"
  ...
  test("drops OTEL resource attributes when any entry is invalid", () => {
    process.env.OTEL_RESOURCE_ATTRIBUTES = "service.namespace=nexus,broken"
  ...
  test("keeps built-in attributes when env values conflict", () => {
    ...
    process.env.OTEL_RESOURCE_ATTRIBUTES =
      "nexus.client=web,service.instance.id=override,service.namespace=nexus"
