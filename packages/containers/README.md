...
```
REGISTRY=ghcr.io/ravipacharpro-jpg TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/ravipacharpro-jpg TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/ravipacharpro-jpg/build/bun-node:24.04
```
